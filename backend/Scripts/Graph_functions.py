...
def funding_barplot(fund_df, selected_tracts):
    ...
    plot_path = f"{parent_dir}/static/img/funding_barplot.png"
...
def changes_scatterplot(old_DAC, new_DAC):
    ...
    plt.tight_layout()
    plot_path = f"{parent_dir}/static/img/changes_scatterplot.png"
    plt.savefig(plot_path)
    plt.close()
...
def changes_barplot(old_DAC, new_DAC):
    ...
    ax.legend()
    plt.tight_layout()
    plot_path = f"{parent_dir}/static/img/changes_barplot.png"
    plt.savefig(plot_path)
    plt.close()
    # "changes_barplot.png"
